...
public class Simple_demo_say_hello_world_0001_Test {
	...
	/*
	 * Simple_demo_say_hello_world_0001_Test
	 * Test generated by IBM App Connect Enterprise Toolkit 12.0.6.0 on Oct 26, 2022 8:45:58 AM
	 */
	...
	public void simple_demo_say_hello_world_TestCase_001() throws TestException {
		...
		SpyObjectReference nodeReference = new SpyObjectReference().application("simple-demo").messageFlow("say_hello").node("world");
